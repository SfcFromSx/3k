...
const characterProfiles = {
  ...
  c_011: { headwear: 'crown', symbol: 'seal', beard: 'mustache', ornament: 'star', robe: '#d2c39a' },
  c_012: { headwear: 'helmet', symbol: 'spear', beard: 'mustache', ornament: 'feather', robe: '#7f6840' },
  c_013: { headwear: 'helmet', symbol: 'spear', beard: 'none', ornament: 'flare', robe: '#d8ddd7' },
  c_014: { headwear: 'hood', symbol: 'fan', beard: 'none', ornament: 'flame', robe: '#d5b57b' },
  c_015: { headwear: 'hood', symbol: 'fan', beard: 'goatee', ornament: 'spire', robe: '#617462' },
  c_016: { headwear: 'crown', symbol: 'seal', beard: 'none', ornament: 'moon', robe: '#d8dce7' },
  c_017: { headwear: 'helmet', symbol: 'blade', beard: 'mustache', ornament: 'bolt', robe: '#596273' },
  c_018: { headwear: 'helmet', symbol: 'halberd', beard: 'mustache', ornament: 'flare', robe: '#4a4d63' },
  c_019: { headwear: 'hood', symbol: 'fan', beard: 'none', ornament: 'star', robe: '#6e7281' },
  c_020: { headwear: 'helmet', symbol: 'blade', beard: 'goatee', ornament: 'ember', robe: '#6a4d39' },
  c_021: { headwear: 'crown', symbol: 'spear', beard: 'none', ornament: 'wave', robe: '#d8a96f' },
  c_022: { headwear: 'hood', symbol: 'fan', beard: 'none', ornament: 'flame', robe: '#d0c7b5' },
  c_023: { headwear: 'helmet', symbol: 'blade', beard: 'none', ornament: 'bolt', robe: '#325b7a' },
  c_024: { headwear: 'helmet', symbol: 'spear', beard: 'none', ornament: 'wave', robe: '#4b708e' },
  c_025: { headwear: 'flower', symbol: 'lotus', beard: 'none', ornament: 'silk', robe: '#f2d6cd' },
  c_026: { headwear: 'crown', symbol: 'seal', beard: 'goatee', ornament: 'flare', robe: '#4f2235' },
  c_027: { headwear: 'crown', symbol: 'seal', beard: 'mustache', ornament: 'moon', robe: '#7d6185' },
  c_028: { headwear: 'hood', symbol: 'orb', beard: 'none', ornament: 'bolt', robe: '#d3b55b' },
  c_029: { headwear: 'hood', symbol: 'moon', beard: 'none', ornament: 'feather', robe: '#e5efe0' },
  c_030: { headwear: 'flower', symbol: 'lotus', beard: 'none', ornament: 'silk', robe: '#ddd6f1' },
};
